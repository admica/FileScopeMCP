...
- [ ] **Phase 33: Symbol Extraction Foundation** — Emit top-level symbols (name, kind, line range, export flag) and imported-name metadata during the existing TS/JS AST walk; add `symbols` schema, repository functions, migration-time bulk extraction, and `npm run inspect-symbols` CLI
...
| 33. Symbol Extraction Foundation | v1.6 | 0/? | Not started | - |
